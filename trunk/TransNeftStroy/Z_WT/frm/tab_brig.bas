...
Columns("AL:AO").ColumnWidth = 6.14
Do
...
For t = 38 To 41
  Range(Cells(s + 6, t), Cells(s + 7, t)).Select
    ...
    format_font_10
Next t
Range(Cells(s + 6, 1), Cells(s + 7, 41)).Select
  Line_all
...
Do While Cells(i, 1) <> ""
  ...
  Range(Cells(i, start_g + 6), Cells(i, start_g + 36)).Select
    format_cell_w
    format_font_10a
  Range(Cells(i, start_g + 37), Cells(i, start_g + 40)).Select
    format_cell_w
    format_font_10a
  Range(Cells(i, start_g), Cells(i, start_g)).RowHeight = 15.75
  Range(Cells(i, start_g), Cells(i, start_g + 40)).Select
    Line_all
i = i + 1
Loop
...
Range(Cells(i, 3), Cells(i, 3)).Select
  format_cell_l_w
  format_font_10b
Range(Cells(i, 38), Cells(i, 39)).Select
  format_cell
  format_font_10b
