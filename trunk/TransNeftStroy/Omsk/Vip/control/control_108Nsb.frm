 Р.form 'control_108aktNsb'
.nameinlist '*Список накладных на отпуск без бухгалтерских проводок'
...
.begin
 ...
 IF RunDialog('C_common::GetIntervalDates',d1,d2,b1)=cmCancel then
  ...
  control_108aktnsb.fexit;                                  //при отказе, выход из пр-мы
 Р   }
  t1.getfirst;
...
.[h                                                      //печать шапки на каждом листе
                        БСписок накладных на сбыт без бухгалтерских проводок Б
                                    Б c  В@@@@@@@@@@ В по  В@@@@@@@@@@ Г
