 Ш.form 'control_109a'
.nameinlist 'Отчет о несоответствии  Шактов на  Шсписание МЦ из производства бухгалтерским проводкам'
...
WHERE ((504==katsopr.vidsopr AND 504==oborot.tidk AND katsopr.nrec==oborot.csoprdoc AND c1==oborot.cplanssch))
...
.begin
 ...
 IF RunDialog(control_102,d1,d2,b1)=cmCancel control_109a.fexit;
 t1.getfirst;
...
.{Table 't1.katsopr'
.[h
                                  Отчет о несоответствии  Шактов на  Шсписание МЦ из производства бухгалтерским проводкам
                                                          c @@@@@@@@@@ по @@@@@@@@@@

 План счетов:@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@                                                         Лист @np@
┌───────────┬───────────────────┬────────────┬───────────────────┬───────────────────┬───────────────────┬───────────────────┬───────────────────┐
│Дескриптор │       Номер       │    Дата    │     Сумма по      │     Сумма по      │     Отклонение    │     Сумма по      │    Отклонение     │
│           │     накладной     │  накладной │     накладной     │     проводкам     │     от проводок   │      ордерам      │    от ордеров     │
└───────────┴───────────────────┴────────────┴───────────────────┴───────────────────┴───────────────────┴───────────────────┴───────────────────┘
.]h
.begin
 c2:=t1.katsopr.nrec;
