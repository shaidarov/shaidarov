...
Columns("BQ:BQ").ColumnWidth = 5
Columns("BR:BS").ColumnWidth = 5.86
Columns("BT:BT").ColumnWidth = 7.14
...
Range(Cells(s, 69), Cells(s + 2, 71)).Select
  ...
  format_cell
  format_font_7
Range(Cells(s, 72), Cells(s + 4, 72)).Select
  ob_cell
  format_cell
  format_font_8
...
Range(Cells(s + 3, 71), Cells(s + 4, 71)).Select
  ...
  format_cell
  format_font_8
Range(Cells(s, 7), Cells(s + 4, 72)).Select
  Line_kr_j
Range(Cells(s + 5, 1), Cells(s + 5, 72)).Select
  format_cell
  format_font_10
  Line_kr_j_v
...
Range(Cells(s + 6, 1), Cells(s + 6, 72)).Select
  format_cell
  format_font_8_I
  Line_kr_j_v
...
Do While Cells(i, 1) <> "" And Cells(i, 1) <> "end"
  ...
  Range(Cells(i, start_g + 32), Cells(i + 3, start_g + 70)).Select
    format_cell_w
    format_font_11
  Range(Cells(i, start_g + 71), Cells(i + 3, start_g + 71)).Select
    ob_cell
    format_cell
    format_font_10
  Range(Cells(i, start_g + 32), Cells(i + 3, start_g + 71)).Select
    Line_kr_j
  Cells(i, 23).Select
...
Range(Cells(i, 2), Cells(i, 22)).Select
  ...
  format_font_11b
  Line_kr
Range(Cells(i, 23), Cells(i, 72)).Select
  format_cell_r_w
  format_font_10
  Line_kr_j_v
Cells(i, 23) = iday
...
Range(Cells(i, 23), Cells(i, 72)).Select
  ...
  Line_kr_j_v
bb = False
If analitik = True Then
  ti = "Итого по объекту:"
Else
  ti = "Итого по листу:"
End If
For t = 1 To i
  If Trim(Cells(t, 2)) = ti Then
    If bb = False Then
      st_f = "=R[-" + CStr(i - t) + "]C"
    Else
      st_f = st_f + "+R[-" + CStr(i - t) + "]C"
