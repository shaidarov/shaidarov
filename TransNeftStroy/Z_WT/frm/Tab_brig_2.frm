.LinkForm 'TAB_BRIG_PER_TNS_2' Prototype is 'BRIGADETBL'
.NameInList 'Табель учета рабочего времени по бригадам ТНС с праздн. часами'
.var
  nf:String
  soz:String
  GetCode:String
...
.begin
    ...
    FBasName:=FBasName+'Tab_brig_2.xls';
...
.begin
      ...
      xlSetCellStringValue('из них праздн', pos_x, 40, pos_x, 40);
      xlSetCellStringValue('объект', pos_x, 41, pos_x, 41);
      xlSetCellStringValue('Б/С', pos_x, 42, pos_x, 42);
      pos_x:=pos_x+1;
...
GetCode:=0;
  ...
  else
  {
    Nameobs := '';
      ...
      xlSetCellStringValue(HolidayHours, pos_x, 40, pos_x, 40);
      xlSetCellStringValue(GetCode, pos_x, 41, pos_x, 41);
      xlSetCellStringValue(soz, pos_x, 42, pos_x, 42);
end.
.}
.begin
      pos_x:=pos_x+1;
      ...
      xlSetCellStringValue(HolidayHoursSum, pos_x, 40, pos_x, 40);
...
.begin
   ...
   xlImportModule('\\fs01-tns.tns.transneft.ru\apps\gal\Resources\BAS\tab_brig_2.bas');
   xlRunMacro('tab_brig_2');
   xlKillExcel;
   Tab_brig_Per_tns_2.fexit;
end.
.endform
